...
const quizData = [
    ...
    {
        pergunta: "7. Qual nutriente ajuda na prevenção da anemia?",
        opcoes: ["Vitamina C", "Vitamina D", "Ferro", "Cálcio"],
        resposta: 2
    },
    {
    ...
    {
        pergunta: "9. Qual método contraceptivo protege contra ISTs?",
